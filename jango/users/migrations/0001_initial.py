        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(
                        blank=True, max_length=32, verbose_name="first_name"
                    ),
                ),
                (
                    "last_name",
                    models.CharField(
                        blank=True, max_length=32, verbose_name="last_name"
                    ),
                ),
                (
                    "email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gender",
                    models.BooleanField(
                        help_text="female is False, male is True, and null is unset",
                        null=True,
                        verbose_name="gender",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(1, "web"), (2, "ios"), (3, "android")], default=3
                    ),
                ),
                (
                    "device_os",
                    models.CharField(
                        blank=True, max_length=25, verbose_name="device os"
                    ),
                ),
                (
                    "device_model",
                    models.CharField(
                        blank=True, max_length=25, verbose_name="device model"
                    ),
                ),
                (
                    "app_version",
                    models.CharField(
                        blank=True, max_length=25, verbose_name="app version"
                    ),
                ),

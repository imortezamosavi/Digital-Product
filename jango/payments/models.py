...
class Payment(models.Model):
    ...
    user = models.ForeignKey('users.User', verbose_name=_('user'), related_name='payments', on_delete=models.CASCADE)
    package = models.ForeignKey('subscriptions.Package', verbose_name=_('package'), related_name='payments', on_delete=models.CASCADE)
    gateway = models.ForeignKey(Gateway, verbose_name=_('gateway'), related_name='payments', on_delete=models.CASCADE)
